...
Here I put the standard deviation as 300, basically in practice it's gambling 
for what the distribution will look like. 

```{r simulate trait of interest}
rnorm(1000, 20, 300)->trait_of_interest ### change this to be a trait that you're actually interested in, with an appropriate distribution! 
