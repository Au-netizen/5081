...
My response variable is probability of Bombus impatiens survival into adulthood
My binary predictor variable is presence of skunks observed within a 5km radius
of the nest site.
My count data predictor variable is number of skunks observed within a 5km
radius of the nest site.

```{r logistic regression}
N=1000
predictor_cont<-rnorm(N,0,1) 
predictor_binary<-rbinom(N,5,0.6)
