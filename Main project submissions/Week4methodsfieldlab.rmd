...
Exclusion criteria:
	...
	tram traffic does not work here, walking trails do not fit. These lead to
	different types of pollutants, which may significantly impact data points
	such as soil content. Plants and pollinators beside train infrastructure
	likely is of a large enough scope to warrant its own project.
	There should be some sort of grassy control nearby every given study site as
	a comparison point.
	

Methods:
	Soil sampling: soil core sampler used 
